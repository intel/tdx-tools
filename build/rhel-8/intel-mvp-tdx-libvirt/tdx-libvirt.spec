...
Requires: intel-mvp-tdx-libvirt-daemon-config-nwfilter = %{version}-%{release}
%if %{with_libxl}
Requires: intel-mvp-tdx-libvirt-daemon-driver-libxl = %{version}-%{release}
%endif
%if %{with_lxc}
Requires: intel-mvp-tdx-libvirt-daemon-driver-lxc = %{version}-%{release}
%endif
%if %{with_qemu}
Requires: intel-mvp-tdx-libvirt-daemon-driver-qemu = %{version}-%{release}
%endif
# We had UML driver, but we've removed it.
Obsoletes: intel-mvp-tdx-libvirt-daemon-driver-uml <= 5.0.0
Obsoletes: intel-mvp-tdx-libvirt-daemon-uml <= 5.0.0
Obsoletes: libvirt-daemon-driver-uml <= 5.0.0
Obsoletes: libvirt-daemon-uml <= 5.0.0
%if %{with_vbox}
Requires: intel-mvp-tdx-libvirt-daemon-driver-vbox = %{version}-%{release}
%endif
Requires: intel-mvp-tdx-libvirt-daemon-driver-nwfilter = %{version}-%{release}

Requires: intel-mvp-tdx-libvirt-daemon-driver-interface = %{version}-%{release}
...
Requires: intel-mvp-tdx-libvirt-daemon-driver-network = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-daemon-driver-nodedev = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-client = %{version}-%{release}
...
Obsoletes: libvirt-docs
Provides: libvirt-docs
...
Obsoletes: libvirt-daemon
Provides: libvirt-daemon
...
Obsoletes: intel-mvp-tdx-libvirt-admin < 7.3.0
Provides: intel-mvp-tdx-libvirt-admin = %{version}-%{release}
Obsoletes: intel-mvp-tdx-libvirt-bash-completion < 7.3.0
...
Obsoletes: libvirt-daemon-config-network
Provides: libvirt-daemon-config-network
...
Obsoletes: libvirt-daemon-config-nwfilter
Provides: libvirt-daemon-config-nwfilter
...
Obsoletes: libvirt-daemon-driver-network
Provides: libvirt-daemon-driver-network
...
Obsoletes: libvirt-daemon-driver-nwfilter
Provides: libvirt-daemon-driver-nwfilter
...
Obsoletes: libvirt-daemon-driver-nodedev
Provides: libvirt-daemon-driver-nodedev
...
Obsoletes: libvirt-daemon-driver-interface
Provides: libvirt-daemon-driver-interface
...
Obsoletes: libvirt-daemon-driver-secret
Provides: libvirt-daemon-driver-secret
...
Obsoletes: libvirt-daemon-driver-storage-core
Provides: libvirt-daemon-driver-storage-core
...
%endif
%if !%{with_storage_rbd}
Obsoletes: intel-mvp-tdx-libvirt-daemon-driver-storage-rbd < %{version}-%{release}
%endif
...
Obsoletes: libvirt-daemon-driver-storage-logical
Provides: libvirt-daemon-driver-storage-logical

Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-core = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-libs = %{version}-%{release}
Requires: lvm2
...
Obsoletes: libvirt-daemon-driver-storage-disk
Provides: libvirt-daemon-driver-storage-disk
...
Obsoletes: libvirt-daemon-driver-storage-scsi
Provides: libvirt-daemon-driver-storage-scsi
...
Obsoletes: libvirt-daemon-driver-storage-iscsi
Provides: libvirt-daemon-driver-storage-iscsi
...
Obsoletes: libvirt-daemon-driver-storage-iscsi-direct
Provides: libvirt-daemon-driver-storage-iscsi-direct
...
Obsoletes: libvirt-daemon-driver-storage-mpath
Provides: libvirt-daemon-driver-storage-mpath
...
Obsoletes: libvirt-daemon-driver-storage-gluster
Provides: libvirt-daemon-driver-storage-gluster
...
Obsoletes: libvirt-daemon-driver-storage-rbd
Provides: libvirt-daemon-driver-storage-rbd
...
Provides: libvirt-daemon-driver-storage-sheepdog
...
Obsoletes: libvirt-daemon-driver-storage-zfs
Provides: libvirt-daemon-driver-storage-zfs
...
Obsoletes: libvirt-daemon-driver-storage
Provides: libvirt-daemon-driver-storage

Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-core = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-disk = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-logical = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-scsi = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-iscsi = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-mpath = %{version}-%{release}
%if %{with_storage_iscsi_direct}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-iscsi-direct = %{version}-%{release}
%endif
%if %{with_storage_gluster}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-gluster = %{version}-%{release}
%endif
%if %{with_storage_rbd}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-rbd = %{version}-%{release}
%endif
%if %{with_storage_sheepdog}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-sheepdog = %{version}-%{release}
%endif
%if %{with_storage_zfs}
Requires: intel-mvp-tdx-libvirt-daemon-driver-storage-zfs = %{version}-%{release}
%endif
...
Obsoletes: libvirt-daemon-driver-qemu
Provides: libvirt-daemon-driver-qemu
...
Obsoletes: libvirt-daemon-driver-lxc
Provides: libvirt-daemon-driver-lxc
...
Obsoletes: libvirt-daemon-driver-vbox
Provides: libvirt-daemon-driver-vbox
...
Provides: libvirt-daemon-driver-libxl

Requires: intel-mvp-tdx-libvirt-daemon = %{version}-%{release}
Requires: intel-mvp-tdx-libvirt-libs = %{version}-%{release}
Obsoletes: intel-mvp-tdx-libvirt-daemon-driver-xen < 4.3.0
...
Obsoletes: libvirt-daemon-qemu
Provides: libvirt-daemon-qemu
...
Obsoletes: libvirt-daemon-kvm
Provides: libvirt-daemon-kvm
...
Obsoletes: libvirt-daemon-lxc
Provides: libvirt-daemon-lxc
...
Obsoletes: libvirt-libs
Provides: libvirt-libs
...
Obsoletes: libvirt-wireshark
Provides: libvirt-wireshark
...
Obsoletes: libvirt-login-shell
Provides: libvirt-login-shell
...
Obsoletes: libvirt-lock-sanlock
Provides: libvirt-lock-sanlock
...
Obsoletes: libvirt-nss
Provides: libvirt-nss
