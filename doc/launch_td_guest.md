...
If running Ubuntu as the host OS, use Ubuntu use templates [direct boot_ubuntu](tdx_libvirt_direct.ubuntu.xml.template) or [grub boot_ubuntu](tdx_libvirt_grub.ubuntu.xml.template)
